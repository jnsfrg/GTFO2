...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class FirstPersonController : MonoBehaviour
    {
        ...
        //check if player is vivible
        public bool IsVisibleForEnemy()
        {
            return !hideing;
        }

        // set if player is visible
        ...
        public GameObject GetEnemyInSight()
        {
            return theEnemyInSight;
        }

        public void SetEnemyInSight(bool s)
        {
            enemyInSight = s;
        }

        public void SetTheEnemyInSight(GameObject g)
        {
            theEnemyInSight = g;
        }
